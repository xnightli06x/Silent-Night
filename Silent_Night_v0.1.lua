...
-- Auto Shop variables
ASIFl1 = 54353 + 1 -- auto shop instant finish local 1 
ASIFl2 = 54353 + 1776 + 1 -- auto shop finish local 2 
ASRBl = 404 -- auto shop reload board local 
...
DCg1 = 1963610 + 812 + 50 + 1 -- doomsday player 1 cut global
DCg2 = 1963610 + 812 + 50 + 2 -- doomsday player 2 cut global
DCg3 = 1963610 + 812 + 50 + 3 -- doomsday player 3 cut global
DCg4 = 1963610 + 812 + 50 + 4 -- doomsday player 4 cut global
...
CPCg1 = 1974520 + 831 + 56 + 1 -- cayo perico player 1 cut global
CPCg2 = 1974520 + 831 + 56 + 2 -- cayo perico player 2 cut global
CPCg3 = 1974520 + 831 + 56 + 3 -- cayo perico player 3 cut global
CPCg4 = 1974520 + 831 + 56 + 4 -- cayo perico player 4 cut global
CPBg = FMg + 29211
CPFHl = 25058  -- cayo perico fingerprint hack local 
CPPCCl = 31123 + 3 -- cayo perico plasma cutter cut local ("DLC_H4_anims_glass_cutter_Sounds") 
CPSTCl = 29883 -- cayo perico drainage pipe cut local
...
ACg1 = 1931323 + 1 + 1 -- global apartment player 1 cut global
ACg2 = 1931323 + 1 + 2 -- global apartment player 2 cut global
ACg3 = 1931323 + 1 + 3 -- global apartment player 3 cut global
ACg4 = 1931323 + 1 + 4 -- global apartment player 4 cut global
ACg5 = 1933291 + 3008 + 1 -- local apartment player 1 cut global
...
DCCg1 = 1967717 + 1497 + 736 + 92 + 1 -- diamond casino player 1 cut global
DCCg2 = 1967717 + 1497 + 736 + 92 + 2 -- diamond casino player 2 cut global
DCCg3 = 1967717 + 1497 + 736 + 92 + 3 -- diamond casino player 3 cut global
DCCg4 = 1967717 + 1497 + 736 + 92 + 4 -- diamond casino player 4 cut global
...
SCVMTl = 565 + 7 		-- special cargo vip mission type local
SCVISl = 565 + 1 		-- special cargo vip instant sell local
...
-- Silent Night Tab
Silent = gui.get_tab("Silent Night 1.71")
Silent:add_text("Silent Night 1.71")
...
function()
	locals.set_int("vehrob_planning",533,2)
end)
Salvage:add_sameline()
...
function()
	if locals.get_int("fmmc_launcher", 19990 + 34) ~= nil then
		if locals.get_int("fmmc_launcher", 19990 + 34) ~= 0 then
			if locals.get_int("fmmc_launcher", 19990 + 34) > 1 then
					locals.set_int("fmmc_launcher", 19990 + 15, 1)
                    globals.set_int(794954 + 4 + 1 + (locals.get_int("fmmc_launcher", 19990 + 34) * 95) + 75, 1)
			end
...
Doomsday:add_button("Instant Finish", function()
    locals.set_int("fm_mission_controller", 19787, 12)
    locals.set_int("fm_mission_controller", 19787 + 1740 + 1, 150)
    locals.set_int("fm_mission_controller", 28407 + 1, 99999)
    locals.set_int("fm_mission_controller", 31663 + 1 + 68, 99999)
    locals.set_int("fm_mission_controller", 31663 + 97, 80)
end)
...
script.register_looped("removeCool", function(remt)
    ...
    if remCD:is_enabled() == true then
		globals.set_int(1876941 + 1 + (PLAYER.PLAYER_ID() * 77) + 76, -1)
		remt:sleep(500)
	end
end)
...
script.run_in_fiber(function(ap)
	local key = globals.get_int(1876941 + (PLAYER.PLAYER_ID() * 77) + 24 + 2)
	local cuts = heistCuts[key]
	globals.set_int(ACg1, 100 - (cuts[2]*locals.get_int("fmmc_launcher", 19990 + 34)))
    ...
    function ()
        ...
        if ImGui.Button("Set Cuts") then
            script.run_in_fiber(function(ccut)
                local heistType = locals.get_int("fmmc_launcher", 19990 + 34)
...
Apartment:add_button("Instant Finish (Pacific)", function()
    locals.set_int("fm_mission_controller", 19787 + 1062, 5)
    locals.set_int("fm_mission_controller", 19787 + 1740 + 1, 80)
    locals.set_int("fm_mission_controller", 19787 + 2686, 10000000)
    locals.set_int("fm_mission_controller", 28407 + 1, 99999)
    locals.set_int("fm_mission_controller", 31663 + 1 + 68, 99999)
end
)
...
MB:add_button("Resupply All", function()
	script.run_in_fiber(function(mcResupply)
		globals.set_int(1668000 + 1 + 6, 1)
		globals.set_int(1668000 + 1 + 6, 1)
		globals.set_int(1668000 + 1 + 6, 1) -- Acid Lab Supplies
		gui.show_message("Acid Lab", "Resupplying your Acid Lab")
		globals.set_int(1668000 + 1 + 5, 1)
		globals.set_int(1668000 + 1 + 5, 1)
		globals.set_int(1668000 + 1 + 5, 1) -- Bunker Supplies
		gui.show_message("Bunker", "Resupplying your Bunker")
		globals.set_int(1668000 + 1 + 0, 1)
		globals.set_int(1668000 + 1 + 0, 1)
		globals.set_int(1668000 + 1 + 0, 1) -- Counterfeit Cash Factory Supplies
		gui.show_message("Counterfeit Cash Factory", "Resupplying your Counterfeit Cash Factory")
		globals.set_int(1668000 + 1 + 1, 1)
		globals.set_int(1668000 + 1 + 1, 1)
		globals.set_int(1668000 + 1 + 1, 1) -- Document Forge Supplies
		gui.show_message("Document Forge", "Resupplying your Document Forge")
		globals.set_int(1668000 + 1 + 2, 1)
		globals.set_int(1668000 + 1 + 2, 1)
		globals.set_int(1668000 + 1 + 2, 1) -- Weed Farm Supplies
		gui.show_message("Weed Farm", "Resupplying your Weed Farm")
		globals.set_int(1668000 + 1 + 3, 1)
		globals.set_int(1668000 + 1 + 3, 1)
		globals.set_int(1668000 + 1 + 3, 1) -- Meth Lab Suplies
		gui.show_message("Meth Lab", "Resupplying your Meth Lab")
		globals.set_int(1668000 + 1 + 4, 1)
		globals.set_int(1668000 + 1 + 4, 1)
		globals.set_int(1668000 + 1 + 4, 1) -- Cocaine Lockup Supplies
...
EasyMoney:add_text("Gives 30mil dollars in a few seconds. Has a cooldown of about 1 hour.")
EasyMoney:add_button("Give 30mil", function()
    script.run_in_fiber(function(script)
