...
AFDl = 10103 + 11 -- apartment fleeca drill local
...
DCDVDl1 = 10143 + 7 -- diamond casino drill vault door local 1
...
GSIg = 1667995 		-- get supplies instantly global ("OR_PSUP_DEL)
...
HCVISl2 = 1985 + 768 -- hangar cargo vip instant sell local 2
...
MB:add_button("Resupply All", function()
	script.run_in_fiber(function(mcResupply)
		...
		globals.set_int(1667995 + 1 + 1, 1)
		globals.set_int(1667995 + 1 + 1, 1) -- Document Forge Supplies
		gui.show_message("Document Forge", "Resupplying your Document Forge")
		globals.set_int(1667995 + 1 + 2, 1)
		globals.set_int(1667995 + 1 + 2, 1)
		globals.set_int(1667995 + 1 + 2, 1) -- Weed Farm Supplies
		gui.show_message("Weed Farm", "Resupplying your Weed Farm")
		globals.set_int(1667995 + 1 + 3, 1)
		globals.set_int(1667995 + 1 + 3, 1)
		globals.set_int(1667995 + 1 + 3, 1) -- Meth Lab Suplies
		gui.show_message("Meth Lab", "Resupplying your Meth Lab")
		globals.set_int(1667995 + 1 + 4, 1)
		globals.set_int(1667995 + 1 + 4, 1)
		globals.set_int(1667995 + 1 + 4, 1) -- Cocaine Lockup Supplies
...
script.register_looped("Gun Van", function()
	gun_van_loc = globals.get_int(2652568 + 2671)
