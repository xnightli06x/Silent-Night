...
CSg1    = 1575036 						-- change session (type) 1 					// Guide:   NETWORK::UGC_SET_USING_OFFLINE_CONTENT(false);
...
-- Auto Shop variables
ASIFl1 = 52171 + 1 -- auto shop instant finish local 1 
ASIFl2 = 52171 + 1776 + 1 -- auto shop finish local 2 
ASRBl = 401 -- auto shop reload board local 
...
DCg1 = 1961513 + 812 + 50 + 1 -- doomsday player 1 cut global
DCg2 = 1961513 + 812 + 50 + 2 -- doomsday player 2 cut global
DCg3 = 1961513 + 812 + 50 + 3 -- doomsday player 3 cut global
DCg4 = 1961513 + 812 + 50 + 4 -- doomsday player 4 cut global
GCg = 2685249 + 6615 -- global cut global (value2 = value2 * (num / 100f);)

-- Cayo Perico Heist Variables
CPRSl = 1564 -- cayo perico reload screen local 
...
AIFl3 = 19783 -- apartment instant finish local 1
AIFl4 = 19783 + 2686 -- apartment instant finish local 2
AIFl5 = 28402 + 1 -- apartment instant finish local 3
AIFl6 = 31658 + 1 + 68
AFHl = 11814 + 24 -- apartment fleeca hack local 
AFDl = 10105 + 11 -- apartment fleeca drill local

-- Diamond Casino Heist Variables
DCRBl = 206 -- diamond casino reload board local
DCCg1 = 1965614 + 1497 + 736 + 92 + 1 -- diamond casino player 1 cut global
...
DCFHl = 53089      -- diamond casino fingerprint hack local
DCKHl = 54155      -- diamond casino keypad hack local
DCDVDl1 = 10145 + 7 -- diamond casino drill vault door local 1
DCDVDl2 = 10145 + 37 -- diamond casino drill vault door local 2
DCXf1 = 19783
DCXf2 = 19783 + 1062
DCXf3 = 19783 + 1740 + 1
DCXf4 = 19783 + 2686
...
GSIg = 1667996 		-- get supplies instantly global ("OR_PSUP_DEL)
BCISl = 1262 + 774 	-- bunker crash instant sell local
...
HCVISl1 = 1985 + 1078 -- hangar cargo vip instant sell local 1
HCVISl2 = 1985 + 1035 -- hangar cargo vip instant sell local 2
...
NLCl = 202 + 32 + 1 -- night loop collect local
...
SCVMTl = 563 + 7 		-- special cargo vip mission type local
SCVISl = 563 + 1 		-- special cargo vip instant sell local
...
-- Silent Night Tab
Silent = gui.get_tab("Silent Night 1.70")
Silent:add_text("Silent Night 1.70")
...
function()
	locals.set_int("vehrob_planning",530,2)
end)
...
function()
	if locals.get_int("fmmc_launcher", 19875 + 34) ~= nil then
		if locals.get_int("fmmc_launcher", 19875 + 34) ~= 0 then
			if locals.get_int("fmmc_launcher", 19875 + 34) > 1 then
					locals.set_int("fmmc_launcher", 19875 + 15, 1)
                    globals.set_int(794744 + 4 + 1 + (locals.get_int("fmmc_launcher", 19875 + 34) * 89) + 69, 1)
			end
...
Doomsday:add_button("Instant Finish", function()
    locals.set_int("fm_mission_controller", 19783, 12)
...
script.register_looped("removeCool", function(remt)
    ...
    if remCD:is_enabled() == true then
		globals.set_int(1877417 + 1 + (PLAYER.PLAYER_ID() * 77) + 76, -1)
		remt:sleep(500)
	end
end)
...
script.run_in_fiber(function(ap)
	...
	globals.set_int(ACg1, 100 - (cuts[2]*locals.get_int("fmmc_launcher", 19875 + 34)))
...
Apartment:add_button("Instant Finish (Pacific)", function()
    ...
    locals.set_int("fm_mission_controller", 19783 + 1740 + 1, 80)
    locals.set_int("fm_mission_controller", 19783 + 2686, 10000000)
    locals.set_int("fm_mission_controller", 28402 + 1, 99999)
    locals.set_int("fm_mission_controller", 31658 + 1 + 68, 99999)
end
)
...
MB:add_button("Resupply All", function()
	script.run_in_fiber(function(mcResupply)
		globals.set_int(1667996 + 1 + 6, 1)
		globals.set_int(1667996 + 1 + 6, 1)
		globals.set_int(1667996 + 1 + 6, 1) -- Acid Lab Supplies
		gui.show_message("Acid Lab", "Resupplying your Acid Lab")
		globals.set_int(1667996 + 1 + 5, 1)
		globals.set_int(1667996 + 1 + 5, 1)
		globals.set_int(1667996 + 1 + 5, 1) -- Bunker Supplies
		gui.show_message("Bunker", "Resupplying your Bunker")
		globals.set_int(1667996 + 1 + 1, 1)
		globals.set_int(1667996 + 1 + 1, 1)
		globals.set_int(1667996 + 1 + 1, 1) -- Document Forge Supplies
		gui.show_message("Document Forge", "Resupplying your Document Forge")
		globals.set_int(1667996 + 1 + 2, 1)
		globals.set_int(1667996 + 1 + 2, 1)
		globals.set_int(1667996 + 1 + 2, 1) -- Weed Farm Supplies
		gui.show_message("Weed Farm", "Resupplying your Weed Farm")
		globals.set_int(1667996 + 1 + 3, 1)
		globals.set_int(1667996 + 1 + 3, 1)
		globals.set_int(1667996 + 1 + 3, 1) -- Meth Lab Suplies
		gui.show_message("Meth Lab", "Resupplying your Meth Lab")
		globals.set_int(1667996 + 1 + 4, 1)
		globals.set_int(1667996 + 1 + 4, 1)
		globals.set_int(1667996 + 1 + 4, 1) -- Cocaine Lockup Supplies
